<div>
    ...
    <div class="d-inline-flex pb-2">
        ...
        <select wire:model="status" wire:loading.attr="disabled" class="form-select form-select-sm" id="publish-status-select">
    ...
    <div class="d-inline-flex pb-2">
        ...
        <select wire:model="visibility" wire:loading.attr="disabled" class="form-select form-select-sm" id="publish-status-select">
